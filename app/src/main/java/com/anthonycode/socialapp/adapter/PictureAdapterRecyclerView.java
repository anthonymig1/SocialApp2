package com.anthonycode.socialapp.adapter;
...
import com.anthonycode.socialapp.view.PictureDetailActivity;
...
public class PictureAdapterRecyclerView extends RecyclerView.Adapter<PictureAdapterRecyclerView.PictureViewHolder>{
    ...
    public void onBindViewHolder(@NonNull PictureViewHolder holder, int position) {
        ...
        Picasso.get().load(picture.getPicture()).memoryPolicy(MemoryPolicy.NO_CACHE).networkPolicy(NetworkPolicy.NO_CACHE).into(holder.pictureCard);
